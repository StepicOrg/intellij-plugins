...
class DownloadSubmission : CodeQuizAction(TEXT, DESCRIPTION, AllStepikIcons.ToolWindow.download) {
    ...
    private fun downloadSubmission(project: Project) {
        ...
        val submissions = ProgressManager.getInstance()
                                  .run(object : Task.WithResult<List<Submission>, RuntimeException>(project,
                                          "Download submission", true) {
    ...
    private fun filterSubmissions(
        ...
        return submissions.filter {
            SupportedLanguages.langOfName(it.reply.language)
                    .canUpgradedTo(currentLang)
        }
    }
    ...
    private fun showPopup(
        ...
        val popup = builder.setTitle("Choose submission")
                .createPopup()
