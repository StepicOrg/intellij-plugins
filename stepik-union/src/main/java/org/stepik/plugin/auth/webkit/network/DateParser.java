...
final class DateParser {
     ...
     */
    static long parse(@NotNull String date) throws ParseException {
        DateParser.Time time = null;
     ...
     */
    private static DateParser.Time parseTime(@NotNull String token) {
     ...
     */
    private static Integer parseDayOfMonth(@NotNull String token) {
     ...
     */
    private static Integer parseMonth(@NotNull String token) {
        if (token.length() >= 3) {
     ...
     */
    private static Integer parseYear(@NotNull String token) {
