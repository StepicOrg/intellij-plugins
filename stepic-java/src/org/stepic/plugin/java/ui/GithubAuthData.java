...
public class GithubAuthData {
  ...
  public static GithubAuthData createFromSettings() {
    return StepicSettings.getInstance().getAuthData();
  }

  public static GithubAuthData createAnonymous() {
    return new GithubAuthData(AuthType.ANONYMOUS, null, null, true);
  }

  public static GithubAuthData createBasicAuth(@NotNull String login, @NotNull String password) {
    return new GithubAuthData(AuthType.BASIC, new BasicAuth(login, password), null, true);
  }

  public static GithubAuthData createBasicAuthTF(@NotNull String login,
                                                 @NotNull String password,
                                                 @NotNull String code) {
    return new GithubAuthData(AuthType.BASIC, new BasicAuth(login, password, code), null, true);
  }

  public static GithubAuthData createTokenAuth(@NotNull String token) {
    return new GithubAuthData(AuthType.TOKEN, null, new TokenAuth(token), true);
  }

  public static GithubAuthData createTokenAuth(@NotNull String token, boolean useProxy) {
    return new GithubAuthData(AuthType.TOKEN, null, new TokenAuth(token), useProxy);
  }
  ...
  public GithubAuthData copyWithTwoFactorCode(@NotNull String code) {
    ...
    return createBasicAuthTF(myBasicAuth.getLogin(), myBasicAuth.getPassword(), code);
  }
