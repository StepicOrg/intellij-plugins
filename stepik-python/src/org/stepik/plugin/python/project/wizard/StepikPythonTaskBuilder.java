...
public class StepikPythonTaskBuilder extends PythonModuleBuilder implements TaskBuilder {
    private static final Logger LOG = Logger.getInstance(StepikPythonTaskBuilder.class);
    private final Task myTask;
    private final Module myUtilModule;

    public StepikPythonTaskBuilder(String moduleDir, @NotNull String name, @NotNull Task task, @NotNull Module utilModule) {
        myTask = task;
