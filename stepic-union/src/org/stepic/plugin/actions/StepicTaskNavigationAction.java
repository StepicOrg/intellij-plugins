...
public abstract class StepicTaskNavigationAction extends StudyTaskNavigationAction {
    private static final Logger LOG = Logger.getInstance(StepicTaskNavigationAction.class);
    public StepicTaskNavigationAction(@Nullable String text, @Nullable String description, @Nullable Icon icon) {
