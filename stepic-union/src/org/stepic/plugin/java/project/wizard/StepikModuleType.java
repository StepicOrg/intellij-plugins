...
import com.jetbrains.edu.utils.generation.StepikProjectGenerator;
...
public class StepikModuleType extends ModuleType<JavaCourseBuilder> {
    ...
    static {
        STEPIK_MODULE_TYPE = (StepikModuleType) instantiate("org.stepic.plugin.java.project.wizard.StepikModuleType");
    }
