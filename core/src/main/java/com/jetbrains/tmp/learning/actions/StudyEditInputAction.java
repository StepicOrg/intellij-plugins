...
import com.jetbrains.tmp.learning.ui.StudyTestContentPanel;
...
public class StudyEditInputAction extends DumbAwareAction {
    ...
    public void showInput(final Project project) {
        ...
        if (selectedEditor != null) {
            ...
            tabbedPane = new JBEditorTabs(project,
            ...
            final JBPopup hint =
                    JBPopupFactory.getInstance()
                            .createComponentPopupBuilder(tabbedPane.getComponent(), tabbedPane.getComponent())
                            .setResizable(true)
                            .setMovable(true)
    ...
    private static UserTest createUserTest(
            @NotNull final VirtualFile testsDir,
    ...
    private TabInfo addTestTab(
            int nameIndex,
            final StudyTestContentPanel contentPanel,
            @NotNull final Task currentTask,
            boolean toBeClosable) {
    ...
    public void update(final AnActionEvent e) {
        ...
        if (project != null) {
            ...
            if (studyEditor != null) {
                final List<UserTest> userTests = StudyTaskManager.getInstance(project)
                        .getUserTests(studyEditor.getTaskFile().getTask());
