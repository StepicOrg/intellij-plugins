 ...
 */
package com.jetbrains.tmp.learning.statistics;
...
public class EduUsagesCollector extends UsagesCollector {
    ...
    public static void projectTypeCreated(@NotNull String projectTypeId) {
        ServiceManager.getService(EduUsagesCollector.class).myUsageDescriptors.get("project.created." + projectTypeId)
                .advance();
    }

    public static void projectTypeOpened(@NotNull String projectTypeId) {
        ServiceManager.getService(EduUsagesCollector.class).myUsageDescriptors.get("project.opened." + projectTypeId)
                .advance();
    }
