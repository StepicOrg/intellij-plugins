...
public class StepikAdaptiveReactionsPanel extends JPanel {
    ...
    private void addFileListener() {
        ...
        myProject.getMessageBus()
                .connect()
                .subscribe(FileEditorManagerListener.FILE_EDITOR_MANAGER, editorManagerListener);
    }
    ...
    private class ReactionButtonPanel extends JPanel {
        ...
        private class ReactionMouseAdapter extends MouseAdapter {
            ...
            public ReactionMouseAdapter(
                    @NotNull final Runnable onClickAction,
                    @NotNull final ReactionButtonPanel mainPanel) {
