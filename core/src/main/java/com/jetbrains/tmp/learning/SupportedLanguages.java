...
public enum SupportedLanguages {
    ...
    HASKELL("Haskell 7.8", "haskell", "Step.hs", "--", new String[]{"module Step where"}, null),
    HASKELL_7_10("Haskell 7.10", "haskell 7.10", "Step.hs", "--", new String[]{"module Step where"}, null),
    HASKELL_8_0("Haskell 8.0", "haskell 8.0", "Step.hs", "--", new String[]{"module Step where"}, null),
