...
class UtilsTest {
    ...
    fun mapToGetStringOneValue() {
        val getString = mapToGetString("param", listOf("10"))
    ...
    fun mapToGetStringManyValues() {
        val getString = mapToGetString("param", listOf("10", "255", "value"))
    ...
    fun mapToGetStringNoOneValues() {
        val getString = mapToGetString("param", listOf())
